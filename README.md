...
QUBOだからxsの要素の値は1か0のどちらかで、だから0日目と1日目の両方に社員0と社員1の両方が出社する場合、つまり全部1の場合以外は0になります。全部1ということは同じ組合せということになるので、その場合に1になるのであればペナルティとして実に都合がよい。あとは、他の社員の組合せと他の日の組合せを網羅するために、4重のループを書いたというわけですな。
